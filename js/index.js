$(function() {
  ...
  var benediction2 = `
  春 天 里 的 第 一 个 星 座 ， 白 羊 座 的 你 阳 光 ， 热 情 ， 天 真 ， 无 邪 ！ 和 小 狗 🐶 小 鸡 🐤 有 说 不 完 的 话 。 让 人 觉 得 又 好 笑 又 喜 欢 。 喜 欢 你 的 一 言 不 合 就 臭 脸 的 坏 脾 气 ， 但 是 句 句 又 在 理 。 没 过 多 久 又 会 和 我 重 归 于 好 。 。 。 
  ...
  var benedDom3 = $("#benediction3");
  print(benediction, benedDom, 50)
  setTimeout(function() {
    print(benediction2, benedDom2, 180)
  }, 1500)
